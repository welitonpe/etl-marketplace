...
export const createProductFromJSONchema = liferayAuthSchema.extend({
	CATALOG_ID: z.string().describe("The catalogId to create the products"),
	CHANNEL_ID: z.string().describe("The channelId to create the products"),
	SITE_ID: z.string().describe("The siteId to create the products"),
});
